...
def create_inbound(db: Session, inbound_data: dict):
    ...
    db_inbound = models.Inbound(
        ...
        total_gb=inbound_data.get("total_gb", 0),
        expiry_time=inbound_data.get("expiry_time", 0),
...
def create_client(db: Session, inbound_id: int, remark: str, total_gb: int = 0, expiry_time: int = 0):
...
# New function to update traffic stats
